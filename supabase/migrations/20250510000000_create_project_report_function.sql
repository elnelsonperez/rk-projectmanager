-- Create function to generate project reports
-- This function computes various metrics for project items including actual costs, 
-- estimated costs, difference percentages, and payment status.
