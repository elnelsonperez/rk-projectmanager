-- Update the get_project_report function to include the description field
-- This will allow item descriptions to be shown in the project report

-- First, drop the existing function
DROP FUNCTION IF EXISTS get_project_report(INT);

-- Then create the new function with the updated return type
CREATE FUNCTION get_project_report(p_project_id INT)
RETURNS TABLE (
  category TEXT,
  area TEXT,
  item_name TEXT,
