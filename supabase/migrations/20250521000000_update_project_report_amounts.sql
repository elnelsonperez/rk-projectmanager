-- Update the get_project_report function to use client_facing_amount instead of amount
-- Also add internal_amount_paid column using the original amount
...
BEGIN
  ...
  SELECT 
    ...
    CASE
      ...
      ELSE pi.client_cost - ts.total_client_facing_amount_paid
