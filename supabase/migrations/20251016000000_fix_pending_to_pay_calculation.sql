-- Fix pending_to_pay calculation to show confirmed cost even when no transactions exist
-- Also rename for clarity: amount_paid -> amount_executed (monto ejecutado)
