...
export default function NewProjectPage() {
    ...
    try {
      ...
      const projectData: ProjectInput = {
        ...
        estimated_completion:
          restData.estimated_completion && restData.estimated_completion !== ''
            ? restData.estimated_completion
            : null
      };
  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Nuevo Proyecto</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <textarea id="notes" {...register('notes')} rows={4} className="w-full p-2 border rounded-md" />
        </div>
        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2 sm:space-x-4 pt-4">
          ...
          <Button type="submit" disabled={isSubmitting} className="text-xs sm:text-sm" size="sm">
